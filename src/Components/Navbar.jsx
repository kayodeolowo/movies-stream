...
const Navbar = () => {
  ...
  const handleNav = () => {
    ...
    return (
        <div className="flex flex-col container mx-auto justify-start   items-start lg:h-[400px]   fixed lg:w-32 lg:ml-6 xl:ml-10  rounded-lg xl:mt-[18%]   lg:mt-[14%]  lg:px-2 
                    ...
                    {/* <div className='' >
                     ...
                     <div className='lg:flex   '> 
                        <ul className=' lg:text-lg font-bold hidden   lg:flex lg:flex-col text-white font-mono   '> 
                                ...
                                <Link to='/'  className=' hover:text-[#E0A040] ml-1 duration-200  mt-6 text-center border-b-2 flex'  >   Movies  <FcHome className='mt-1 ml-1'> </FcHome>    </Link>
                    ...
                    <ul data-aos="fade-up"  className='lg:hidden ml-4  font-semibold mt-10 font-fira  flex flex-col '>
                      <Link to='/'  className=' flex text-yellow-500 justify-center duration-200 t mt-6  border-b-2 '  >   Movies  <FcHome className='mt-3 ml-1'> </FcHome>    </Link>
                            ...
                            <Link to='toprated-series' className='  flex mt-3 duration-200' >     TopRated <MdOutlineStarRate className='ml-1 mt-3 text-blue-500'> </MdOutlineStarRate>  </Link>  
                             ...
                             <p className='text-gray-500 text-sm mt-[50%] sm:mt-[180%]'>  <a href='https://themoviedb.org/documentation/api'>Themoviedb</a>  </p>
