...
export const SeriesTrailer = () => {
  ...
  return (
    <div className="container mx-auto mt-2">
      <div> 
          <h1 className="text-center mx-4 lg:mx-0 lg:mt-4 text-xl sm:text-2xl font-semibold text-yellow-500  "> Series Clip </h1>
