  ...
  return (
    <div>
       <div className='container mx-auto pt-2 sm:pt-6 '>
        ...
        <h1 className='text-white mx-auto text-inherit sm:mx-6 text-xl mt-4 font-semibold text-center lg:text-start  '> <BsDot className='text-white
 dark:text-gray-800'> </BsDot> </h1>
        <Search/>

         <h1 className=' border border-[#E0A040] w-fit mx-auto rounded-md px-2 py-1 mb-8 text-lg sm:text-xl mt-10 font-semibold text-center  text-white lg:mt-10'> Upcoming Movies </h1>
