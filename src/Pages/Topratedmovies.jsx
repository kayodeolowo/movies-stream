...
const Topratedmovies = () => {
 ...
 dark:text-gray-800'> </BsDot> </h1>
        <Search/>
         ...
         <h1 className=' border border-[#E0A040] w-fit mx-auto rounded-md px-2 py-1 mb-8 text-lg sm:text-xl mt-10 font-semibold text-center  text-white lg:mt-10 '> Toprated Movies </h1>
